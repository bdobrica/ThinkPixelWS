...
- [x] ENG-007 Implement shared UUIDv7, injectable clock, typed errors, bounded strings, digest types, and authenticated cursors. — completed 2026-08-31, commit 3a7d38d, evidence: `GOTOOLCHAIN=go1.25.14 go test ./...`; `GOTOOLCHAIN=go1.25.14 go vet ./...`; `GOTOOLCHAIN=go1.25.14 go test -race ./...`; `GOTOOLCHAIN=go1.25.14 go mod verify`; `make verify`; `git diff --check`
